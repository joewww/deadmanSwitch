...
contract('DeadmanSwitch', function (accounts) {
  ...
  /* check that the beneficiary is set to 0xf46a36B1EAfDa5F7597395EEAB4c89992F851308 */
  ...
  /* check that the initial allowed withdraw time is equal to December 25, 2018 */
  ...
  /* sanity check: ensure that 1 year is 31556926 seconds */
  ...
  /* do not allow transferring the beneficiary address to 0x0 */
  ...
  /* check that withdraws work for owner */
  ...
  /* test the circuit breaker feature. pauses should not allow withdraws */
